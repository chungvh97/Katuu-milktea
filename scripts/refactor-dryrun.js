/*
  Simple refactor dry-run script to copy selected directories into a new src/ MVC layout.
  Usage:
    node scripts/refactor-dryrun.js       # dry-run
    node scripts/refactor-dryrun.js --apply  # actually copy files
*/
